"""
Dataset class for the imputation model HELIX_NoFusion.
"""
...
class DatasetForHELIX_NoFusion(BaseDataset):
    """Dataset for HELIX_NoFusion model that needs MIT (masked imputation task) in training.
