"""
Dataset class for the imputation model HELIX_NoHybrid.
"""
...
class DatasetForHELIX_NoHybrid(BaseDataset):
    """Dataset for HELIX_NoHybrid model that needs MIT (masked imputation task) in training.
