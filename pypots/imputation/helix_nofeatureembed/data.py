"""
Dataset class for the imputation model HELIX_NoFeatureEmbed.
"""
...
class DatasetForHELIX_NoFeatureEmbed(BaseDataset):
    """Dataset for HELIX_NoFeatureEmbed model that needs MIT (masked imputation task) in training.
