"""
The implementation of HELIX_NoFeatureEmbed for the partially-observed time-series imputation task.
"""
...
from .core import _HELIX_NoFeatureEmbed
from .data import DatasetForHELIX_NoFeatureEmbed
...
class HELIX_NoFeatureEmbed(BaseNNImputer):
    """The PyTorch implementation of the HELIX_NoFeatureEmbed model (Ablation Study).
    ...
    saving_path :
        The path for automatically saving model checkpoints.

    model_saving_strategy :
        The strategy to save model checkpoints.
    ...
    def __init__(
        ...
        lr: float = 0.001,
        lr_decay_patience: Optional[int] = None,
        min_lr: float = 1e-6,
        ...
        self.model = _HELIX_NoFeatureEmbed(
            n_steps=n_steps,
    ...
    def _print_model_configuration(self):
        if self.verbose:
            logger.info("=" * 60)
            logger.info(f"HELIX_NoFeatureEmbed Model Configuration (Ablation):")
            logger.info("=" * 60)
    ...
    def fit(
        ...
        train_dataset = DatasetForHELIX_NoFeatureEmbed(
        ...
        if val_set is not None:
            ...
            val_dataset = DatasetForHELIX_NoFeatureEmbed(
